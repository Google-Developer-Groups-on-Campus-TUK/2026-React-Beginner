...
function BlueskyIcon() {
  return (
    <svg className="w-4 h-4" viewBox="0 0 16 17" fill="currentColor">
...
export default function Footer() {
  return (
    <footer className="bg-gray-900 text-gray-400">
      <div className="max-w-6xl mx-auto px-10 py-6 flex items-center justify-between text-sm">
        <span className="text-gray-500">판다마켓 &nbsp;|&nbsp; 2024</span>
        ...
        <div className="flex items-center gap-3">
          ...
          <a href="#" className="text-gray-400 hover:text-white transition-colors"><BlueskyIcon /></a>
